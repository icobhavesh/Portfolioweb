const Contact_from = () => {
    return (
        <>
            <section className="body-font relative bg-[#0a192f]  text-gray-400">

                <div className="container mx-auto px-5 py-24">

                    <div className="mb-12 flex w-full flex-col text-center">
                        <h1 className="title-font mb-4 text-6xl md:text-5xl font-medium text-white sm:text-4xl">Contact  Me</h1>
                        <p className="mx-auto text-base leading-relaxed lg:w-2/3">Send  me a message
                        </p>
                    </div>
                    ...
                    <div className="mx-auto md:w-2/3 lg:w-1/2">
                        <div className="-m-2 flex flex-wrap">
                            ...
                            <div className="w-full p-2">
                                <button className="mx-auto flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none">Let's Collaborate</button>
                            </div>
